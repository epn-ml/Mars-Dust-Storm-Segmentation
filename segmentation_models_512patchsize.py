...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath='./512 resized patches G04 and G05 - binaryCrossEntropy/unet_inceptionv3_100epochs_G05G04_512patchsize.h5',
...
plt.title('Training and validation loss unet_inceptionv3_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('Loss')
...
plt.title('Training and validation IOU unet_inceptionv3_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('IOU')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
with open('./512 resized patches G04 and G05 - binaryCrossEntropy/unet_resnet34.csv', 'w', newline='') as f:
    writer = csv.writer(f)
...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath='./512 resized patches G04 and G05 - binaryCrossEntropy/unet_resnet34_100epochs_G05G04_512patchsize.h5',
    monitor='val_iou_score',
    mode='max',
    save_best_only=True, verbose=1)
...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath='./512 resized patches G04 and G05 - binaryCrossEntropy/unet_vgg16_100epochs_G05G04_512patchsize.h5',
    monitor='val_iou_score',
    mode='max',
    save_best_only=True, verbose=1)
...
plt.plot(epochs, loss, 'y', label='Training loss')
plt.plot(epochs, val_loss, 'r', label='Validation loss')
plt.title('Training and validation loss unet_vgg16_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
plt.plot(epochs, acc, 'y', label='Training IOU')
plt.plot(epochs, val_acc, 'r', label='Validation IOU')
plt.title('Training and validation IOU unet_vgg16_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('IOU')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
rows = zip(loss, val_loss, acc, val_acc)
with open('./512 resized patches G04 and G05 - binaryCrossEntropy/unet_vgg16.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    writer.writerow(['Training loss', 'Validation loss', 'Training IOU', 'Validation IOU'])
    for row in rows:
        writer.writerow(row)
...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath='./512 resized patches G04 and G05 - binaryCrossEntropy/linknet_inceptionv3_100epochs_G05G04_512patchsize.h5',
    monitor='val_iou_score',
    mode='max',
    save_best_only=True, verbose=1)
...
plt.plot(epochs, loss, 'y', label='Training loss')
plt.plot(epochs, val_loss, 'r', label='Validation loss')
plt.title('Training and validation loss linknet_inceptionv3_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
plt.plot(epochs, acc, 'y', label='Training IOU')
plt.plot(epochs, val_acc, 'r', label='Validation IOU')
plt.title('Training and validation IOU linknet_inceptionv3_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('IOU')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
rows = zip(loss, val_loss, acc, val_acc)
with open('./512 resized patches G04 and G05 - binaryCrossEntropy/linknet_inceptionv3.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    writer.writerow(['Training loss', 'Validation loss', 'Training IOU', 'Validation IOU'])
    for row in rows:
        writer.writerow(row)
...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath='./512 resized patches G04 and G05 - binaryCrossEntropy/linknet_resnet34_100epochs_G05G04_512patchsize.h5',
    monitor='val_iou_score',
    mode='max',
    save_best_only=True, verbose=1)
...
plt.plot(epochs, loss, 'y', label='Training loss')
plt.plot(epochs, val_loss, 'r', label='Validation loss')
plt.title('Training and validation loss linknet_resnet34_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
plt.plot(epochs, acc, 'y', label='Training IOU')
plt.plot(epochs, val_acc, 'r', label='Validation IOU')
plt.title('Training and validation IOU linknet_resnet34_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('IOU')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
rows = zip(loss, val_loss, acc, val_acc)
with open('./512 resized patches G04 and G05 - binaryCrossEntropy/linknet_resnet34.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    writer.writerow(['Training loss', 'Validation loss', 'Training IOU', 'Validation IOU'])
    for row in rows:
        writer.writerow(row)
...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath='./512 resized patches G04 and G05 - binaryCrossEntropy/fpn_resnet18_100epochs_G05G04_512patchsize.h5',
    monitor='val_iou_score',
    mode='max',
    save_best_only=True, verbose=1)
...
plt.plot(epochs, loss, 'y', label='Training loss')
plt.plot(epochs, val_loss, 'r', label='Validation loss')
plt.title('Training and validation loss fpn_resnet18_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
plt.plot(epochs, acc, 'y', label='Training IOU')
plt.plot(epochs, val_acc, 'r', label='Validation IOU')
plt.title('Training and validation IOU fpn_resnet18_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('IOU')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
rows = zip(loss, val_loss, acc, val_acc)
with open('./512 resized patches G04 and G05 - binaryCrossEntropy/fpn_resnet18.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    writer.writerow(['Training loss', 'Validation loss', 'Training IOU', 'Validation IOU'])
    for row in rows:
        writer.writerow(row)
...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath='./512 resized patches G04 and G05 - binaryCrossEntropy/fpn_resnet34_100epochs_G05G04_512patchsize.h5',
    monitor='val_iou_score',
    mode='max',
    save_best_only=True, verbose=1)
...
plt.plot(epochs, loss, 'y', label='Training loss')
plt.plot(epochs, val_loss, 'r', label='Validation loss')
plt.title('Training and validation loss fpn_resnet34_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
plt.plot(epochs, acc, 'y', label='Training IOU')
plt.plot(epochs, val_acc, 'r', label='Validation IOU')
plt.title('Training and validation IOU fpn_resnet34_100epochs_G05G04_512patchsize')
plt.xlabel('Epochs')
plt.ylabel('IOU')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.show()
...
rows = zip(loss, val_loss, acc, val_acc)
with open('./512 resized patches G04 and G05 - binaryCrossEntropy/fpn_resnet34.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    writer.writerow(['Training loss', 'Validation loss', 'Training IOU', 'Validation IOU'])
    for row in rows:
        writer.writerow(row)
...
model1 = load_model('./512 resized patches G04 and G05 - binaryCrossEntropy/models/unet_resnet34_100epochs_G05G04_512patchsize.h5', compile=False)
model2 = load_model('./512 resized patches G04 and G05 - binaryCrossEntropy/models/unet_inceptionv3_100epochs_G05G04_512patchsize.h5', compile=False)
model3 = load_model('./512 resized patches G04 and G05 - binaryCrossEntropy/models/unet_vgg16_100epochs_G05G04_512patchsize.h5', compile=False)
model4 = load_model('./512 resized patches G04 and G05 - binaryCrossEntropy/models/linknet_resnet34_100epochs_G05G04_512patchsize.h5', compile=False)
model5 = load_model('./512 resized patches G04 and G05 - binaryCrossEntropy/models/linknet_inceptionv3_100epochs_G05G04_512patchsize.h5', compile=False)
model6 = load_model('./512 resized patches G04 and G05 - binaryCrossEntropy/models/fpn_resnet18_100epochs_G05G04_512patchsize.h5', compile=False)
model7 = load_model('./512 resized patches G04 and G05 - binaryCrossEntropy/models/fpn_resnet34_100epochs_G05G04_512patchsize.h5', compile=False)
