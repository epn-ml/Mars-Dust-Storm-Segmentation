...
for test_lbl in test_labels:
    ...
    plt.text(0.5, -0.2, str(round(iou_df["model1"][cnt], 3)), ha='center', va='center', transform=plt.gca().transAxes, fontsize=35)
    plt.xticks([])  # remove x-axis values
    plt.yticks([])  # remove y-axis values
    plt.subplot(1, 10, 5)
    #plt.title('unet_2d_DenseNet121_1024ps')
    plt.imshow(test_prediction2)
    plt.text(0.5, -0.1, str(round(iou_df["model2"][cnt], 3)), ha='center', va='center', transform=plt.gca().transAxes, fontsize=35)
    plt.xticks([])  # remove x-axis values
    plt.yticks([])  # remove y-axis values
    plt.subplot(1, 10, 6)
    #plt.title('att_unet_2d_DenseNet201_1024ps')
    plt.imshow(test_prediction3)
    plt.text(0.5, -0.1, str(round(iou_df["model3"][cnt], 3)), ha='center', va='center', transform=plt.gca().transAxes, fontsize=35)
    plt.xticks([])  # remove x-axis values
    plt.yticks([])  # remove y-axis values
    plt.subplot(1, 10, 7)
    #plt.title('unet_plus_2d_ResNet152_1024ps')
    plt.imshow(test_prediction4)
    plt.text(0.5, -0.1, str(round(iou_df["model4"][cnt], 3)), ha='center', va='center', transform=plt.gca().transAxes, fontsize=35)
    plt.xticks([])  # remove x-axis values
    plt.yticks([])  # remove y-axis values
    plt.subplot(1, 10, 8)
    #plt.title('unet_inceptionv3_1024ps')
    plt.imshow(test_prediction5)
    plt.text(0.5, -0.1, str(round(iou_df_5["model1"][cnt], 3)), ha='center', va='center', transform=plt.gca().transAxes, fontsize=35)
    plt.xticks([])  # remove x-axis values
    plt.yticks([])  # remove y-axis values
    plt.subplot(1, 10, 9)
    #plt.title('unet_inceptionv3_512ps')
    plt.imshow(test_prediction6)
    plt.text(0.5, -0.1, str(round(iou_df_67["model1"][cnt], 3)), ha='center', va='center', transform=plt.gca().transAxes, fontsize=35)
    plt.xticks([])  # remove x-axis values
    plt.yticks([])  # remove y-axis values
    plt.subplot(1, 10, 10)
